...
import mmpose
mmpose_config_dir = osp.join(osp.dirname(mmpose.__file__), ".mim") + "/"
...
class TestInference(TestCase):
    ...
    @parameterized.expand([((mmpose_config_dir+'configs/body_2d_keypoint/topdown_heatmap/coco/'
